      ...
      <Container maxWidth="lg">
        <Box className={classes.root} py={5}>
          ...
          <Typography color="textSecondary">
            Our M&E department provides you with professional monitoring and
            evaluation services to support strategic decision-making. We help
            you track your progress across the continuum of your project. This
            helps you fast-track your goals while minimizing resources
